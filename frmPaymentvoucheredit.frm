...
Begin VB.Form frmPaymentvoucheredit 
   BackColor       =   &H00808080&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Payment Voucher Edit"
   ClientHeight    =   6015
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   13305
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSDBGrid.DBGrid DBGrid1 
         Bindings        =   "frmPaymentvoucheredit.frx":0000
         Height          =   1935
         Left            =   120
         OleObjectBlob   =   "frmPaymentvoucheredit.frx":0014
         TabIndex        =   8
         Top             =   120
         Width           =   12855
      End
      Begin MSDBGrid.DBGrid DBGrid2 
         Bindings        =   "frmPaymentvoucheredit.frx":13E3
         Height          =   2535
         Left            =   120
         OleObjectBlob   =   "frmPaymentvoucheredit.frx":13F7
         TabIndex        =   9
         Top             =   2160
         Width           =   12855
      End
   ...
   Begin VB.Data Data1 
      ...
      ReadOnly        =   0   'False
      RecordsetType   =   1  'Dynaset
      RecordSource    =   "PaymentHead"
      Top             =   2760
      Width           =   1140
   End
End
Attribute VB_Name = "frmPaymentvoucheredit"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim BEFORE_DISCOUNT, BEFORE_AMOUNT, rec1 As DAO.Recordset, rec2 As Recordset, rec3 As Recordset
...
Private Sub DBGrid1_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
    ...
    Data2.RecordSource = "SELECT * FROM PAYMENTDETAILS WHERE SLNO=" & Me.DBGrid1.Columns(0) & " AND PDATE=#" & temp_month & "/" & temp_day & "/" & temp_year & "#"
    Data2.Refresh
End Sub
...
On Error GoTo errtrap
    ...
    Data1.RecordSource = "select * from PaymentHead order by PDate,Slno"
    Exit Sub
errtrap:
...
Private Sub txtToDt_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = 13 Then
        ...
        Data1.RecordSource = "select * from PaymentHead  where PDate between #" & Accperiod_month & "/" & Accperiod_day & "/" & Accperiod_year & "# and #" & temp_month & "/" & temp_day & "/" & temp_year & "#"
        Data1.Refresh
