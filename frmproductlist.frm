...
Begin VB.Form frmproductlist 
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "frmproductlist.frx":0000
      Height          =   3495
      Left            =   120
      OleObjectBlob   =   "frmproductlist.frx":0014
      TabIndex        =   1
      Top             =   480
      Width           =   11115
   End
...
Private Sub DBGrid1_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = 13 Then
        If FORMNAME = "Purchase" Then
            ...
            frmStockin.txtmrp.Text = Me.DBGrid1.Columns(7)
            frmStockin.TxtVat.Text = Me.DBGrid1.Columns(9)
            frmStockin.cbounit.Text = Me.DBGrid1.Columns(10)
            frmStockin.txtPrate.Text = Me.DBGrid1.Columns(8)
            Unload Me
            frmStockin.txtpack.SetFocus
        End If
        If FORMNAME = "Purchase_Barcode" Then
            ...
            frmStockint.txtmrp.Text = Me.DBGrid1.Columns(7)
            frmStockint.TxtVat.Text = Me.DBGrid1.Columns(10)
            frmStockint.cbounit.Text = Me.DBGrid1.Columns(11)
            frmStockint.txtPrate.Text = Me.DBGrid1.Columns(13)
            frmStockint.txttaxtype.Text = Me.DBGrid1.Columns(12)
            Unload Me
        ...
        If FORMNAME = "Invoice" Then
            ...
            frmInvoice.txtmrp.Text = Me.DBGrid1.Columns(7)
            frmInvoice.txtsalerate.Text = Me.DBGrid1.Columns(8)
            frmInvoice.TxtVat.Text = Me.DBGrid1.Columns(10)
            frmInvoice.cbounit.Text = Me.DBGrid1.Columns(11)
            frmInvoice.txttaxtype.Text = Me.DBGrid1.Columns(12)
            frmInvoice.cbobatch.AddItem Me.DBGrid1.Columns(4)
            Unload Me
            'frmInvoice.txtpack.SetFocus
        End If
        If FORMNAME = "InvoiceR" Then
            frmInvoiceR.cboitemname.Text = Trim(Me.DBGrid1.Columns(1))
            frmInvoiceR.txtproductcode.Text = Trim(Me.DBGrid1.Columns(0))
            frmInvoiceR.txtmrp.Text = Me.DBGrid1.Columns(7)
            frmInvoiceR.txtsalerate.Text = Me.DBGrid1.Columns(8)
            frmInvoiceR.TxtVat.Text = Me.DBGrid1.Columns(10)
            frmInvoiceR.cbounit.Text = Me.DBGrid1.Columns(11)
            frmInvoiceR.txttaxtype.Text = Me.DBGrid1.Columns(12)
            frmInvoiceR.cbobatch.AddItem Me.DBGrid1.Columns(4)
            Unload Me
            'frmInvoice.txtpack.SetFocus
        End If
...
Private Sub Form_Load()
    ...
    Me.Data1.Refresh
    Else
    Me.Data1.RecordSource = "select * from stockdetails where Itemname like '" & Replace(SEARCHWORD, "'", "''") & "*' order by Itemname"
    Me.Data1.Refresh
    End If
End Sub
...
'Me.Data1.RecordSource = "Select Stock.ProductCode,Stock.itemname,Stock.Lose,Stock.MRP,Stock.SaleRate,Stock.Qty,ItemMaster.Tax,Stock.UniyType,ItemMaster.tax_type from Stock inner Join ItemMaster on Stock.ProductCode=ItemMaster.ProductCode where Stock.ItemName Like '" & Me.txtproductname.Text & "*'"
    ...
    Else
        ...
        Me.Data1.RecordSource = "select * from stockdetails where Itemname like '*" & Replace(Me.txtproductname.Text, "'", "''") & "*' order by Itemname"
        Me.Data1.Refresh
    End If
End Sub
