...
Private Sub cmdprint_Click()
    ...
    Me.CrystalReport1.ReportFileName = App.Path & "\purchase.rpt"
    ...
    Me.CrystalReport1.SelectionFormula = "{PurchaseHead.Purchasedate} in Date (" & temp_from_year & "," & temp_from_month & "," & temp_from_date & ") to Date (" & temp_to_year & "," & temp_to_month & "," & temp_to_date & ")"
