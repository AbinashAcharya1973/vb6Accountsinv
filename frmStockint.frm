...
Begin VB.Form frmStockint 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Stock Entry/Purchase Entry[Barcode In]"
   ClientHeight    =   9225
   ClientLeft      =   45
   ClientTop       =   210
   ClientWidth     =   14340
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "frmStockint.frx":0000
      Height          =   3495
      Left            =   120
      OleObjectBlob   =   "frmStockint.frx":0014
      TabIndex        =   54
      Top             =   3000
      Width           =   14115
   End
...
Private Sub cbobatch_GotFocus()
    Me.lblmessage.Caption = "Press Esc To Go To Item"
    Me.cbobatch.SelStart = 0
    Me.cbobatch.SelLength = Len(Me.cbobatch.Text)
End Sub
...
On Error GoTo errtrap
    'Dim dbSession As DAO.Workspace, crDb As DAO.Database
    'Set dbSession = DBEngine(0)
    'Set crDb = dbSession.OpenDatabase(db.Name)
            ...
            If Not rec2.EOF Then
                While Not rec2.EOF
                    ...
                    Else
                        ...
                        If Not rec1.EOF Then
                            dbs.Execute ("insert into Stockdetails (ProductType,itemtype,itemname,brand,barcode,size,MRP,PRate,Qty,ProductCode,Vat,Lose,UniyType,SaleRate,mfgdate,batchno,expdate,hsn) values('" & rec1("ProductType") & "','" & rec1("itemtype") & "','" & Replace(rec1("item"), "'", "''") & "','" & rec1("brand") & "','" & Replace(rec1("barcode"), "'", "''") & "','" & rec1("size") & "'," & rec1("mrp") & "," & rec1("purchaserate") & "," & rec2("qty") + rec2("free_qty") & "," & rec2("Productcode") & "," & rec2("vat") & "," & rec1("Lose") & ",'" & rec1("unittype") & "'," & rec1("SaleRate") & ",'" & rec2("mfgdate") & "','" & rec2("batchno") & "','" & rec2("expdate") & "','" & rec1("HSN") & "')")
                        End If
                    End If
                    rec2.MoveNext
                Wend
