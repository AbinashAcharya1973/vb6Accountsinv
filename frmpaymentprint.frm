...
Begin VB.Form frmpaymentprint 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Payment Voucher Printing"
   ClientHeight    =   3480
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   8115
   ...
   Begin VB.Data Data1 
      ...
      RecordSource    =   "PaymentDetails"
      Top             =   1620
      Visible         =   0   'False
      Width           =   1185
   End
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "frmpaymentprint.frx":0000
      Height          =   2385
      Left            =   120
      OleObjectBlob   =   "frmpaymentprint.frx":0014
      TabIndex        =   2
      Top             =   570
      Width           =   7965
   End
   ...
   End
End
Attribute VB_Name = "frmpaymentprint"
...
Private Sub Form_Load()
    ...
    Data1.RecordSource = "select * from paymentdetails order by pdate,slno"
    Data1.Refresh
    Me.DBGrid1.Refresh
End Sub
Public Sub PDFprint(rcno, rcdate As Date)
    ...
    OFile = App.Path & "\payment.pdf"

    objPDF.Title = "Payment Voucher"
    ...
    Set rec1 = db.OpenRecordset("select * from paymentdetails where slno=" & rcno & " and pdate=#" & Format(rcdate, "mm/dd/yyyy") & "#")
    If Not rec1.EOF Then
        tempaccname = rec1("accname")
        tempamount = rec1("amount")
    End If
    
    Set rec1 = db.OpenRecordset("select * from paymenthead where slno=" & rcno & " and pdate=#" & Format(rcdate, "mm/dd/yyyy") & "#")
    If Not rec1.EOF Then
    ...
    lineno = lineno - 0.5
    objPDF.DrawText 10.3, lineno, "PAYMENT VOUCHER", "Fnt4", 10, pdfCenter
    lineno = lineno - 1
    ...
    lineno = lineno - 1
    objPDF.DrawText 1, lineno, "Paid To " & tempaccname, "Fnt5", 12, pdfAlignLeft
    lineno = lineno - 0.7
...
Private Sub txtsearch_KeyPress(KeyAscii As Integer)
    ...
    Me.Data1.RecordSource = "select * from paymentdetails where accname like '" & Me.txtsearch.Text & "*' order by pdate,slno"
    Me.Data1.Refresh
    Me.DBGrid1.Refresh
End Sub
