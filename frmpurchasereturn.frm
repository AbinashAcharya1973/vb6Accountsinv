...
Begin VB.Form frmpurchasereturn 
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "frmpurchasereturn.frx":0000
      Height          =   3735
      Left            =   120
      OleObjectBlob   =   "frmpurchasereturn.frx":0014
      TabIndex        =   73
      Top             =   3360
      Width           =   13815
   End
...
Private Sub txtSlno_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = 13 Then
        db.Execute ("delete * from Temppurchasereturn")
        Set rec2 = db.OpenRecordset("select * from PurchaseReturnHead where Slno=" & Me.txtslno.Text)
        If Not rec2.EOF Then
