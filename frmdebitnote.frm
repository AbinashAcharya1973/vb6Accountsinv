...
Private Sub cmdSave_Click()
    ...
    If ans = 6 Then
        ...
        If Not rec1.EOF Then
            ...
            End If
            db.Execute ("insert into LedgerTran (Slno,TDate,Particulars,Dr,Cr,Balance,AccId,Remarks,VoucherType,VoucherSlno,GroupId,TranAccId) values(" & tempslno & ",'" & Me.txtStockindate.Text & "','To DISCOUNT ON PURCHASE'," & Me.txtfinal.Text & ",0,0," & Me.cboSupplier.ItemData(Me.cboSupplier.ListIndex) & ",'" & Trim(Me.txtparticulars.Text) & "','Debit Note'," & Me.txtslno.Text & "," & party_groupid & "," & cr_accid & ")")
            ...
            Else
                tempslno = 1
            End If
            db.Execute ("insert into LedgerTran (Slno,TDate,Particulars,Dr,Cr,Balance,AccId,Remarks,VoucherType,VoucherSlno,GroupId,TranAccId) values(" & tempslno & ",'" & Me.txtStockindate.Text & "','By " & Me.cboSupplier.Text & "',0," & Me.txtamount.Text & ",0," & cr_accid & ",'" & Trim(Me.txtparticulars.Text) & "','Debit Note'," & Me.txtslno.Text & "," & cr_groupid & "," & Me.cboSupplier.ItemData(Me.cboSupplier.ListIndex) & ")")
            If Val(Me.txtsgst.Text) > 0 Then
                ...
                If Not rec3.EOF Then
                    ...
                    Else
                        tempslno = 1
                    End If
                    db.Execute ("insert into LedgerTran (Slno,TDate,Particulars,Dr,Cr,Balance,AccId,Remarks,VoucherType,VoucherSlno,GroupId,TranAccId) values(" & tempslno & ",'" & Me.txtStockindate.Text & "','By " & Me.cboSupplier.Text & "',0," & Me.txtsgst.Text & ",0," & sgst_accid & ",'" & Trim(Me.txtparticulars.Text) & "','Debit Note'," & Me.txtslno.Text & "," & sgst_groupid & "," & Me.cboSupplier.ItemData(Me.cboSupplier.ListIndex) & ")")
                End If
                ...
                If Not rec3.EOF Then
                    ...
                    Else
                        tempslno = 1
                    End If
                    db.Execute ("insert into LedgerTran (Slno,TDate,Particulars,Dr,Cr,Balance,AccId,Remarks,VoucherType,VoucherSlno,GroupId,TranAccId) values(" & tempslno & ",'" & Me.txtStockindate.Text & "','By " & Me.cboSupplier.Text & "',0," & Me.txtcgst.Text & ",0," & cgst_accid & ",'" & Trim(Me.txtparticulars.Text) & "','Debit Note'," & Me.txtslno.Text & "," & cgst_groupid & "," & Me.cboSupplier.ItemData(Me.cboSupplier.ListIndex) & ")")
                End If
            End If
            If Val(Me.txtigst.Text) > 0 Then
                ...
                If Not rec3.EOF Then
                    ...
                    Else
                        tempslno = 1
                    End If
                    db.Execute ("insert into LedgerTran (Slno,TDate,Particulars,Dr,Cr,Balance,AccId,Remarks,VoucherType,VoucherSlno,GroupId,TranAccId) values(" & tempslno & ",'" & Me.txtStockindate.Text & "','By " & Me.cboSupplier.Text & "',0," & Me.txtigst.Text & ",0," & igst_accid & ",'" & Trim(Me.txtparticulars.Text) & "','Debit Note'," & Me.txtslno.Text & "," & igst_groupid & "," & Me.cboSupplier.ItemData(Me.cboSupplier.ListIndex) & ")")
                End If
            End If
        End If
...
Private Sub Form_Load()
    Set rec1 = db.OpenRecordset("select max(slno) as maxslno from debitnote")
    If Not IsNull(rec1!maxslno) Then
        Me.txtslno.Text = rec1!maxslno + 1
    Else
        Me.txtslno.Text = 1
    End If
    Set rec1 = db.OpenRecordset("select * from ledgermaster where groupname='Sundry Creditor'")
    If Not rec1.EOF Then
        While Not rec1.EOF
...
If KeyCode = 13 Then
    If DELETEDEBIT = True Then
        ans = MsgBox("DELETE THE DEBIT NOTE?", vbYesNo)
        If ans = 6 Then
            db.Execute ("DELETE * FROM LEDGERTRAN WHERE VoucherType='Debit Note' and VoucherSlno=" & Me.txtslno.Text)
            db.Execute ("DELETE * FROM debitnote WHERE Slno=" & Me.txtslno.Text)
            MsgBox "Debit Note Deleted Successfuly", vbOKOnly
        End If
    End If
End If
Exit Sub
