...
Begin VB.Form frmInvoiceB 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin MSDBGrid.DBGrid DBGrid1 
         Bindings        =   "frmInvoiceB.frx":0000
         Height          =   3015
         Left            =   120
         OleObjectBlob   =   "frmInvoiceB.frx":0014
         TabIndex        =   58
         Top             =   120
         Width           =   14295
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cbopaymentmode 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmInvoiceB.frx":244F
         Left            =   6360
         List            =   "frmInvoiceB.frx":2451
         Style           =   2  'Dropdown List
         TabIndex        =   91
         Top             =   1680
         Width           =   2655
      ...
      Begin VB.ComboBox cbocash 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmInvoiceB.frx":2453
         Left            =   7440
         List            =   "frmInvoiceB.frx":2455
         Style           =   2  'Dropdown List
         TabIndex        =   0
         Top             =   240
         Width           =   1575
