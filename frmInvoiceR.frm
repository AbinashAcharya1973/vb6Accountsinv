...
Begin VB.Form frmInvoiceR 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin MSDBGrid.DBGrid DBGrid1 
         Bindings        =   "frmInvoiceR.frx":0000
         Height          =   3855
         Left            =   120
         OleObjectBlob   =   "frmInvoiceR.frx":0014
         TabIndex        =   58
         Top             =   0
         Width           =   14295
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cbocash 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmInvoiceR.frx":293F
         Left            =   7440
         List            =   "frmInvoiceR.frx":2941
         Style           =   2  'Dropdown List
         TabIndex        =   0
         Top             =   240
         Width           =   1575
...
Private Sub txtrrate_GotFocus()
Me.txtrrate.SelStart = 0
Me.txtrrate.SelLength = Len(Me.txtrrate.Text)
End Sub

Private Sub txtrrate_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = 13 Then
        If Val(Me.txtrrate.Text) > 0 Then
            Me.txtsalerate.Text = Round(Val(Me.txtrrate.Text) / (1 + Val(Me.TxtVat.Text) / 100), 2)
        End If
        Me.txtsalerate.SetFocus
    End If
End Sub
