...
Begin VB.Form frmInvoiceBR 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin MSDBGrid.DBGrid DBGrid1 
         Bindings        =   "frmInvoiceBR.frx":0000
         Height          =   3015
         Left            =   120
         OleObjectBlob   =   "frmInvoiceBR.frx":0014
         TabIndex        =   58
         Top             =   120
         Width           =   14295
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cbopaymentmode 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmInvoiceBR.frx":244F
         Left            =   6360
         List            =   "frmInvoiceBR.frx":2451
         Style           =   2  'Dropdown List
         TabIndex        =   91
         Top             =   1680
         Width           =   2655
      ...
      Begin VB.ComboBox cbocash 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmInvoiceBR.frx":2453
         Left            =   7440
         List            =   "frmInvoiceBR.frx":2455
         Style           =   2  'Dropdown List
         TabIndex        =   0
         Top             =   240
         Width           =   1575
   ...
   End
End
Attribute VB_Name = "frmInvoiceBR"
...
Private Sub txtbarcode_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = 13 Then
        Set rec1 = db.OpenRecordset("select * from itemmaster where barcode='" & Me.txtbarcode.Text & "'")
        If Not rec1.EOF Then
            i = 0
            Do While i < Me.cboitemname.ListCount
                If Me.cboitemname.ItemData(i) = rec1("productcode") Then
                    Me.cboitemname.ListIndex = i
                    Me.txtQty.SetFocus
                    Exit Do
                End If
            ...
            Loop
        Else
            MsgBox "Barcode Not Found", vbCritical
        End If
    End If
End Sub
